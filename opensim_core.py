...
with cd(opensim_core_dir):
    ...
    call("svn2git file://%s "
            ...
            "--exclude 'OpenSim/Applications/Gui/annotationTool' "
            "--exclude 'OpenSim/Applications/Gui/branding' "
            "--exclude 'OpenSim/Applications/Gui/coordinateViewer' "
            "--exclude 'OpenSim/Applications/Gui/functionEditor' "
            "--exclude 'OpenSim/Applications/Gui/Help' "
            "--exclude 'OpenSim/Applications/Gui/jcommon' "
            "--exclude 'OpenSim/Applications/Gui/jfreechart' "
            "--exclude 'OpenSim/Applications/Gui/Libs' "
            "--exclude 'OpenSim/Applications/Gui/logger' "
            "--exclude 'OpenSim/Applications/Gui/modelInfo' "
            "--exclude 'OpenSim/Applications/Gui/nbproject' "
            "--exclude 'OpenSim/Applications/Gui/plot' "
            "--exclude 'OpenSim/Applications/Gui/plotter' "
            "--exclude 'OpenSim/Applications/Gui/resources' "
            "--exclude 'OpenSim/Applications/Gui/tracking' "
            "--exclude 'OpenSim/Applications/Gui/utils' "
            "--exclude 'OpenSim/Applications/Gui/view' "
            "--exclude 'OpenSim/Applications/Gui/vtk50' "
            "--exclude 'OpenSim/Applications/Gui/xmlgraphics-commons-1.2svn' "
            "--exclude 'OpenSim/Applications/Gui/build.xml' "
            "--exclude 'Installer' "
